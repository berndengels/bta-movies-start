...
<form enctype="multipart/form-data" method="post" action="/movies/store<?php if($id): echo "/$id"; endif; ?>">
    ...
    <div class="form-group row">
        <label for="author" class="col-md-2 col-form-label">Preis</label>
        <div class="col-md-10">
        <select name="author_id" id=""  class="form-control col-sm-12 col-md-6 px-1" required>
            <?php foreach($authors as $author) { ?>
                <option value="<?php echo $author['id'] ?>" <?php if(isset($data) && $data['author_id'] === $author['id']) {echo 'selected';} ?>>
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <input type="number" step="0.01" id="price" name="price" class="form-control col-sm-12 col-md-6 px-1" 
